...
from handlers.on_start.help import help_router
...
from handlers.on_start.items.price_diagram.back import back_from_diagram_router
...
async def main():
    ...
    dp.include_routers(on_start_router, my_items_router, input_item_router, back_from_add_item,
                       ...
                       update_treshhold_options_router, price_diagram_router, back_from_diagram_router, support_router,
                       help_router)
